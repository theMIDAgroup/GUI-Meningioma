...
pos.PANELgui_check.panel=round([820,70,330,160].*pos.scale_factor);    
...
gui_ROI.PANELroi.PANEL2.panel=uipanel('parent',gui_ROI.PANELroi.panel,...
    'Title','ROI kind',...
    'units','pixel',...
    'Position',pos.PANELroi.PANEL2.panel,'FontWeight','bold','FontSize',gui_ROI.fs,'BackGroundColor',gui_ROI.bgc,'ForeGroundColor',gui_ROI.fgc);
