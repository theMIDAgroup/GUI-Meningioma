...
%%%%
%%%% called by: radiomics_merged()

function Write_xlsx_Radiomics_merged(globalTextures_field_name,...
...
aux2 = getfield(radiomics_merge{1},nonTexture_field_name);
aux3 = getfield(radiomics_merge{1},matrix_based_textures_field_name);
