...
% -------------------------------------------------------------------------
% DESCRIPTION: 
% This function draws a 3D lego-like plot from a bitmask
% inputs:
...
% offset -  3-component vector added to the coordinate of all patches  
%           drawn(default=[0 0 0])
...
% -------------------------------------------------------------------------
%%%% called by: Segmentation_Analysis_brain()
