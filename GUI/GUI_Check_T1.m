...
% 'Next slice' and 'Previous slice'. Once finished, clickn'Done' in order 
% to save changes and continue with the radiomics analysis (T1).
% -------------------------------------------------------------------------
%%%% called by: Start_Analysis_brain()
%%%%            main_gui_brain(), button "Check segmentation T1 on GUI"
%%%% call:  Show_ROI()
%%%%        Save_Last_Slice()
%%%%        Go_Previous_Slice()
%%%%        Go_Next_Slice()
...
pos.Radio_scelta = [435,595,680,50].*pos.scale_factor;
...
gui_T1.SLIDERcontrast = uicontrol(gui_T1.panel,...
    ...
    'FontSize',gui_ROI.fs,...
    'enable','on',...
    'Callback','Slider_Contrast_GUI_Check');
...
gui_T1.SLIDERwindowUp_push=uicontrol(gui_T1.panel,'Style','pushbutton',...
    ...
    'FontSize',gui_ROI.fs,...
    'enable','on',...
    'callback', 'Slider_WindowUp_GUI_Check;');
...
gui_T1.SLIDERwindowDown_push=uicontrol(gui_T1.panel,'Style','pushbutton',...
    ...
    'FontSize',gui_ROI.fs,...
    'enable','on',...
    'callback', 'Slider_WindowDown_GUI_Check;');
...
gui_T1.Radio_scelta = uibuttongroup(gui_T1.panel,...
    'units', 'pixel',...
     'position',pos.Radio_scelta,...
     'BackGroundColor',gui_ROI.bgc_drop,...
     'ForeGroundColor',gui_ROI.bgc_drop,...
     'Visible','on');
 
gui_T1.rb_ls = uicontrol(gui_T1.Radio_scelta,...
    'Style','radiobutton',...
    'units','pixel',...
    'Position',pos.rb_ls,...
...
gui_T1.rb_fwd = uicontrol(gui_T1.Radio_scelta,...
    'Style','radiobutton',...
    'units','pixel',...
    'Position',pos.rb_fwd,...
    'String','2',... %forward
...
set(gui_T1.Radio_scelta,'Visible','on')
