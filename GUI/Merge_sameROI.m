...
% function creates a new xlsx file with the radiomics of the union (one
...
radiomics_merged2D('volume_image.mat', 'volume_image', 'volume_mask_merged.mat',...
    'volume_mask','number_of_slices_after_resize_merged',...
    'globalTextures', 'matrix_based_textures',...
    'nonTexture',[subj,'_radiomics2D_merged.xlsx'],...
    Info.PixelSizeMR(1),Info.PixelSizeMR(2));

radiomics_merged('volume_image.mat', 'volume_image', 'volume_mask_merged.mat',...
    'volume_mask',...
    'globalTextures', 'matrix_based_textures',...
    'nonTexture',[subj,'_radiomics_merged.xlsx'],...
    Info.PixelSizeMR(1),Info.PixelSizeMR(2));
