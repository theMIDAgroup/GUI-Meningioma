...
if ~nonTexture
    if ~strcmp(textType,'Global') && ~strcmp(textType,'Matrix') && ~strcmp(textType,'nonTexture2D')  % MODIFIED VC, IC
...
if ~nonTexture
    ...
    %COMMENTATO DA ISA!!! da if numel(size(ROIbox))==3!!!
